...
<div class="container" style="margin-top: 50px; margin-bottom: 50px;">
	<div class="row">
		<div class="offset-md-3 col-md-6">
			...
			<a href="home.php" class="btn btn-warning btn-sm">GO BACK</a>
		</div>
	</div>
					...
					<?php foreach ($faqs as $faq): ?>
						<tr>
							...
							<td>
								...
								<!-- delete form -->
								<form method="POST" action="faq/delete.php" onsubmit="return confirm('Are you sure you want to delete this FAQ ?');">
